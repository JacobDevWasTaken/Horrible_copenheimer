...
# Beacuase I'm too stupid to write it myself
# However, i did do some improvements so that I dont need to open multiple sockets
...
class StatusPing:
    ...
    def get_status(self, connection: socket.socket):
